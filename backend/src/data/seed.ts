...
const missions = [
  {
    ...
    description:
      "Kappa Theta Pi is built on three guiding pillars. Can you name all of them?",
  ...
  },
  {
    ...
    category: "History",
    description:
      "When and where was Kappa Theta Pi founded nationally?",
  ...
  },
  {
    ...
    description:
      "Match each KTP executive member to their correct position.",
